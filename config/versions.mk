...
ifdef BLISS_RELEASE
    ...
    BLISS_VERSION := $(BLISS_TYPE_NAME)-v$(VERSION)-$(BLISS_BUILD)-$(BLISS_BUILDTYPE)$(BLISS_SPECIAL_VARIANT)-$(BLISS_BUILD_VARIANT)-$(shell date +%Y%m%d)
endif
