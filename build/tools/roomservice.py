...
custom_local_manifest = ".repo/local_manifests/bliss_devices.xml"
custom_default_revision = "typhoon"
...
bliss_manifest = ".repo/manifests/bliss.xml"
lineage_manifest = ".repo/manifests/los.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    blissm = load_manifest(bliss_manifest)
    ...
    for repo in repos:
        ...
        elif exists_in_tree(blissm, repo_path) != None:
             existing_m_project = exists_in_tree(blissm, repo_path)
