...
custom_local_manifest = ".repo/local_manifests/bliss.xml"
custom_default_revision = "12"
custom_dependencies = "bliss.dependencies"
org_manifest = "BlissRoms"  # leave empty if org is provided in manifest
org_display = "BlissRoms"  # needed for displaying
